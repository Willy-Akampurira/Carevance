...
<div class="w-full mx-auto bg-white shadow rounded-lg p-6">
    ...
    <div>
        <table class="table-auto border border-gray-200 rounded-lg w-full">
                ...
                @forelse($patients as $patient)
                    <tr class="border-t text-xl">
                        ...
                        <td class="px-4 py-2 space-x-3">
                            <a href="{{ route('patients.show', $patient->id) }}" class="text-blue-600 hover:underline">View</a> 
                            <a href="{{ route('patients.edit', $patient->id) }}" class="text-yellow-600 hover:underline">Edit</a> 
...
function triggerPatientSearch() {
    ...
    if(query.length > 0) {
        ...
        // If empty, reload without search

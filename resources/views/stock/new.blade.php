{{-- resources/views/drugs/new_stock.blade.php --}}
@extends('layouts.app')
    ...
    <div class="w-full overflow-x-auto border border-gray-200 rounded-md shadow-sm">
        <table class="min-w-full divide-y divide-gray-200 text-left whitespace-nowrap">
            ...
            <tbody class="bg-white divide-y divide-gray-100 text-sm sm:text-base text-gray-700">
                @php
                    // Filter down to active, unexhausted lots to prevent structural rendering artifacts
                    ...
                    <tr class="hover:bg-gray-50/70 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border
                                {{ $lot->status === 'new' ? 'bg-green-50 border-green-200 text-green-700' : 'bg-gray-50 border-gray-200 text-gray-600' }}">
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center text-sm sm:text-base text-gray-500 bg-gray-50/50">
                            No new stock or batch assignments available within active inventory parameters.
                        </td>
                    </tr>
                @endforelse
            </tbody>

...
<div class="flex items-center justify-between">
    <h2 class="font-semibold text-3xl text-gray-800 leading-tight">Add Department</h2> 
</div>
@endsection
    ...
    <form action="{{ route('staff.departments.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4"
                      class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm text-lg focus:border-green-500 focus:ring-green-500">{{ old('description') }}</textarea>
        </div>

<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full text-lg focus:border-green-500 focus:ring-green-500" type="email" name="email" :value="old('email')" required autofocus />

<x-guest-layout>
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-6 pt-4 border-t border-gray-100 flex flex-col space-y-1">
                <p class="text-sm text-gray-600">
                    Already have an account? 
                    <a class="text-green-600 hover:text-green-700 font-medium underline focus:outline-none focus:ring-2 focus:ring-green-500 rounded" href="{{ route('password.request') }}">

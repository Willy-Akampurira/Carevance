...
<div class="w-full mx-auto bg-white shadow rounded-lg p-6 space-y-6">
    ...
    <form method="POST" action="{{ route('suppliers.invoices.store', $supplierId) }}">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="notes" rows="3"
                          class="w-full border rounded px-3 py-2 text-xl  focus:ring-green-500 focus:border-green-500">{{ old('notes') }}</textarea>
            </div>
        </div>

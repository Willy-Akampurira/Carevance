...
<div class="w-full mx-auto bg-white shadow rounded-lg p-6 space-y-6">
    ...
    <form method="POST" action="{{ route('suppliers.deliveries.store', $supplierId) }}">
        @csrf
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
                <div class="md:col-span-2">
                    ...
                    <select name="items[0][drug_id]" class="w-full border rounded px-3 py-2 text-xl  focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <input name="items[0][batch_number]" value="{{ old('items.0.batch_number') }}"
                           class="w-full border rounded px-3 py-2 text-xl  focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" min="0" name="items[0][quantity_received]" value="{{ old('items.0.quantity_received') }}"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="items[0][unit_cost]" value="{{ old('items.0.unit_cost') }}"
                           required class="w-full border rounded px-3 py-2 text-xl  focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
            <p class="text-gray-600 mt-2">For now, add one item. Later we can wire dynamic rows with JS/Livewire.</p>
        </div>
